...
class SDBulmaContainer extends _wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  constructor() {
    ...
    this.state = this.constructor.getInitialState(width, colorBG, removePadding, alignment);
  }
  ...
  render() {
    ...
    const containerClass = classnames__WEBPACK_IMPORTED_MODULE_5___default()('container', size);
    const styles = {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__["InspectorControls"], {
      ...
      options: [{
        ...
        label: 'Fluid, stretch content',
        value: 'fluidc'
      }, {
        label: 'Fluid, keep content width',
        value: 'fluid'
      }],
      onChange: width => {
        this.changeValue('width', width);
      }
    }), width === 'fluidc' ? /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["ToggleControl"], {
      label: "Remove container padding-left and -right?",
      checked: removePadding,
      help: removePadding ? 'no padding' : 'padding',
      onChange: removePadding => this.changeValue('removePadding', removePadding)
      ...
      colors: _utils_colors__WEBPACK_IMPORTED_MODULE_4__["colors"],
      value: colorBG,
      ...
      isSecondary: true
    }, "Top"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Button"], {
      isSecondary: true
    }, "center"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Button"], {
      isSecondary: true
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])('sd/bulma-container', {
